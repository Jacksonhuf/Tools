...
| 命令 | 说明 |
|------|------|
| `npm ci && npm run build && npm test` | 全量 Vitest（**104** 用例；PG 见 `ci-postgres-int`） |
...
- [development-progress.md](./development-progress.md) — Loop 1–29 日志
