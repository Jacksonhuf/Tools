...
const sheetVariants = cva(
  "fixed z-50 gap-4 border border-border/60 bg-surface-2 p-0 shadow-lg transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 border-b border-border/50 px-5 py-4 pr-12 text-center sm:text-left",
      className
    )}
    {...props}
  />
